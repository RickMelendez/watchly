                                ...
                                {item?.dropdown && hovered === item?.id && (
                                    ...
                                    >
                                        <motion.div
                                            ...
                                            className='mt-4 flex w-64 flex-col rounded bg-background border border-border shadow-md'
                                            layoutId={'cursor'}
                                        >
                                            {item?.items?.map((nav) => {
                                                return (
                                                    <motion.a
                                                        key={`link-${nav?.id}`}
                                                        href={`${nav?.url}`}
                                                        className={'w-full p-4 hover:bg-muted text-foreground transition-colors'}
                                                    >
                                                        {nav?.title}
                                                    </motion.a>
                                                );
